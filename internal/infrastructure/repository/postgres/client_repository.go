...
func (r *ClientRepository) Create(ctx context.Context, client domain.Client) error {
	...
	_, err := r.db.ExecContext(ctx, query, client.ID, client.FullName, client.Email, client.BirthDate, client.Country, client.CreatedAt)
	if err != nil {
...
func (r *ClientRepository) List(ctx context.Context) ([]domain.Client, error) {
	...
	for rows.Next() {
		var client domain.Client
		if err := rows.Scan(&client.ID, &client.FullName, &client.Email, &client.BirthDate, &client.Country, &client.CreatedAt); err != nil {
